    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/OTAProject',
                    component: () => import(/* webpackChunkName: "403" */ '../components/page/OTAUpdate/ApiProject.vue'),
                    meta: { title: 'OTA测试' }
                },
                
                {
                    path: '/install',
                    component: () => import(/* webpackChunkName: "403" */ '../components/page/installArray/installArray.vue'),
                    meta: { title: '安装部署' }
                },
